...
class MeasureUtil {
  ...
  //计算计算地表贴地距离，单位：米
  static getClampLength(positions, options) {
    let all_distance = 0
    const arrDistance = []
...
//计算地表投影平面面积，单位：平方米
  static getArea(positions, noAdd) {
...
//计算贴地面积
  static getClampArea(positions, options) {
...
//求地表方位角，返回：0-360度
  static getAngle(firstPoint, endPoints) {
