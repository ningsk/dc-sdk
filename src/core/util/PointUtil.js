 ...
 * @version: 
 * @Author: sueRimn
 * @Date: 2021-03-11 12:26:49
 * @LastEditors: sueRimn
 * @LastEditTime: 2021-03-12 09:05:00
 */
import Log from './Log'
...
class PointUtil {
    ...
    static getHeadingPitchRollByOrientation(position, orientation, ellipsoid = Cesium.Ellipsoid.WGS84, fixedFrameTransform = Cesium.Transforms.eastNorthUpToFixedFrame) {
        let matrix = Cesium.Matrix4.fromRotationTranslation(
            Cesium.Matrix3.fromQuaternion(orientation, matrix3Scratch, ellipsoid, fixedFrameTransform),
            position,
            matrix4Scratch
        )
