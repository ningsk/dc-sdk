 ...
 * @LastEditors: 宁四凯
 * @LastEditTime: 2020-08-14 14:04:37
 */
class AttrPolyline {
  ...
  static style2Entity(style, entityAttr) {
    ...
    if (style.color || style.lineType) {
      var color = new Cesium.Color.fromCssColorString(style.color || "#FFFF00").withAlpha(Number(style.opacity || 1.0));
      var outlineColor = new Cesium.Color.fromCssColorString(style.outlineColor || "#FFFF00").withAlpha(Number(style.opacity || 1.0));
        ...
        case "dash": 
          ...
          if (style.outline) {
            ...
            entityAttr.material = new Cesium.PolylineDashMaterialProperty({
              ...
              color: color,
              gapColor: new Cesium.Color.fromCssColorString(style.outlineColor || "#FFFF00").withAlpha(Number(
