 ...
 * @LastEditors: 宁四凯
 * @LastEditTime: 2020-08-28 09:59:38
 */
...
class PointConvert {
  ...
  //百度经纬度坐标 转 标准WGS84坐标
  static bd2wgs(arrdata) {
    return gcj2wgs(bd2gcj(arrdata));
  }

  //标准WGS84坐标  转 百度经纬度坐标
  static wgs2bd(arrdata) {
    return gcj2bd(wgs2gcj(arrdata));
  }

  //经纬度转Web墨卡托
  static jwd2mct(arrdata) {
    var lng = Number(arrdata[0]);
    var lat = Number(arrdata[1]);
