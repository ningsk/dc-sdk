...
class PlotUtil {
    ...
    static getAzimuth (startPnt, endPnt) {
        ...
        if (endPnt[1] >= startPnt[1] && endPnt[0] >= startPnt[0]) { azimuth = angle + Math.PI } else if (endPnt[1] >= startPnt[1] && endPnt[0] < startPnt[0]) { azimuth = TWO_PI - angle } else if (endPnt[1] < startPnt[1] && endPnt[0] < startPnt[0]) azimuth = angle
